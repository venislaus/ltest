<div class="wrap">
    <h2><?php _e('Update Activity Type','conversation_activity'); ?>
...
<form enctype="multipart/form-data" class="adminAddEdit" action="" method="post">
	...
	<div class="postbox" id="linkadvanceddiv">
		<div class="inside" style="float: left; width: 98%; clear: both;">
			<table cellspacing="5" cellpadding="5" id="conversation_activity_table">
				<tbody>
					<tr>				
						<td><legend>Activity Type : </legend></td>
						<td> <input type="text" name="activity_name" value="<?php echo set_value('activity_name',$edit_rec['activity_name']); ?>" /> </td>
					</tr>
                   	<tr>
						<td><legend> </legend></td>
						<td> 
                            <input type="hidden" value="<?php echo $edit_rec['id']; ?>" name="activity_id" />
                            <input type="submit" value="Update" class="button bold" name="save_activity_list" />
                        </td>
					</tr>
				</tbody>
			</table>
