...
*/
		...
		var $className = "ds_pagination";
		var $parameterName = "page";
		var $urlF = false;//urlFriendly

		/*Buttons next and previous*/
		var $nextT = "";
		var $nextI = "<i class='fa fa-angle-right' aria-hidden='true'></i>"; //&#9658;
		var $prevT = "";
		var $prevI = "<i class='fa fa-angle-left' aria-hidden='true'></i>"; //&#9668;
