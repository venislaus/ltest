<div class="wrap">
    <h2><?php _e('Add Outcome','conversation_outcome'); ?>
...
<form enctype="multipart/form-data" class="adminAddEdit" action="" method="post">
	...
	<div class="postbox" id="linkadvanceddiv">
		<div class="inside" style="float: left; width: 98%; clear: both;">
			<table cellspacing="5" cellpadding="5" id="conversation_outcome_form_table">
				<tbody>
					<tr>
                        <td><legend>Outcome Name : </legend></td>
                        <td> <input type="text" name="outcome_name" value="<?php echo set_value('outcome_name'); ?>" /> </td>
                    </tr>
                    <tr>
					...
					<tr>				
						<td><legend> </legend></td>
						<td>
                            <input type="submit" value="Save" class="button bold" name="save_outcome_list" /> </td>
					</tr>
